 ...
 AnsiString Naglowek(int langId)
 {
  ...
  " WPROWADZANIE DANYCH:\n"
  " Przedzia³y musz¹ byæ wprowadzane w nawiasach kwadratowych\n"
  " przez podanie obu granic przedzia³u, oddzielonych przecinkiem \n"
  "                             [inf,sup]\n"
  " np. [1.2,0.15e-1]\n"
  " b¹dŸ przez podanie jednej liczby\n"
  " np. [52e-1] -> Result=[5.2,5.2]\n\n"
  " Przy czym poprawnym separatorem dziesiêtnym jest kropka \'.\'\n"
  ...
  " szerokoœæ przedzia³u           :  width[,]\n"
  " promien                        :  rad[,]\n"
  " srodek                         :  mid[,]\n"
  " odleg³oœæ dwóch przedzia³ów    :  [,]dist[,]\n"
  " wartoœæ bezwzglêdna            :  abs[,]\n"
  " potêga naturalna               :  [,]^[n] \n"
  ...
  " Macierze i wektory wprowadzamy wiersz po wierszu oddzielone œrednikiem \';\' :\n"
  ...
  " Rozwi¹zanie uk³adu równan AX=B        :  <.A.>solve<.B.> \n"
  " gdzie A musi byæ macierz¹ kwadratow¹ a B wektorem. \n"
  " Rozwi¹zanie uk³adu równan AX=B        :  <.A.>solvef<.B.> \n"
  " z u¿yciem rozk³adu gaussp \n"
  " Rozwi¹zanie uk³adu równan AX=B        :  <.A.>solvef<.B.> \n"
  " z u¿yciem rozk³adu gaussf \n"
  " A/B  jest wykonywane za pomoc¹ A*inv(B) \n"
  " Norma nieskonczona macierzy           : norm<A> \n"
  " tzn. najwiêksza z sum wierszy macierzy \n"
  " Wspó³czynnik uwarunkowania macierzy   : cond<A> \n"
  " Pozosta³e operacje elementarne s¹ wykonywane na poszczególnych elementach macierzy\n\n"
  " Skróty klawiaturowe:\n"
  " CTRL+M - otwiera okno wprowadzania macierzy.\n"
  " CTRL+F - wprowadza ostatnio obliczony wynik do lini komend\n"
  " CTRL+D - wprowadza ostatni¹ komednê\n\n"
  ...
  " WPROWADZANIE DANYCH:\n"
  " Liczby rzeczywiste musz¹ wyæ wprowadzane w formacie\n"
  "           ddd.dddE-ddd\n"
  " np. 123.3E-3\n"
  " z kropk¹ '.' dziesiêtn¹\n\n"
  " OPERACJE ARYTMETYCZNE:\n"
  ...
  " zmiana znaku                   :  -(x)\n\n"
  " FUNKCJE PRZEDZIA£OWE:\n"
  " szerokoœæ przedzia³u           :  width(x)\n"
  " promien                        :  rad(x)\n"
  " srodek                         :  mid(x)\n"
  " odleg³oœæ dwóch przedzia³ów    :  (x)dist(x)\n"
  " wartoœæ bezwzglêdna            :  abs(x)\n"
  " potêga naturalna               :  (x)^[n] \n"
  ...
  const AnsiString FormatMessagePL = "Zaznacz wyra¿enie do formatowania i spróbuj ponownie.";
  ...
  const AnsiString mnuJezyk_CaptionPL = "Jêzyk";
  ...
  const AnsiString edtCommand_HintPL = "Wstaw dowolne wyra¿enie matematyczne. Dozwolone zmienne: i - numer wiersza, j - numer kolumny, m - iloœæ wierszy, n - iloœæ kolumn";
  ...
  AnsiString lblOpis_Caption(int langId)
  {
    ...
    return "IntComp jest zaawansowanym systemem algebry przedzia³owej."
           " Umo¿liwia wykonywanie obliczeñ i badañ z zakresu algebry"
